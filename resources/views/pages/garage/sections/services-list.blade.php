<section id="services" class="relative bg-[#f4f5f7] py-24 font-[var(--font-sans)] overflow-hidden">
    <div class="max-w-7xl mx-auto px-6">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
            <!-- Carte Entretien -->
            <div id="entretien" class="group relative bg-white shadow-lg overflow-hidden">
                ...
                <div class="relative bg-white px-8 py-10 text-[var(--color-secondary)]">
                    ...
                    <ul class="text-sm text-[var(--color-tertiary)] space-y-2">
            ...
            <!-- Carte Diagnostic -->
            <div id="diagnostic" class="group relative bg-white shadow-lg overflow-hidden">
            ...
            <!-- Carte Pneus -->
            <div id="pneus" class="group relative bg-white shadow-lg overflow-hidden">
                <div class="relative h-48 bg-gradient-to-br from-[var(--color-primary)] to-[var(--color-secondary)]">
                    <div class="absolute inset-0 bg-black/20"></div>
                    <div class="absolute inset-0 flex items-center justify-center">
                        <svg class="w-16 h-16 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
